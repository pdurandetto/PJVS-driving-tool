...
def SetImpedance(*args): 
    if len(args) == 1: # set impedances for Waveform Synthesis and Quantization test, first channel at low impedance, all the others at 50 Ohm
    ...
    elif len(args)== 2: # set impedances for IV characteristics, one channel at 50 Ohm, one channel to low impedance and all the others at high impedance

        device, subsection_status = args #subsection_status: list of 1 or 0, 1 means "ON", 0 means "OFF"
